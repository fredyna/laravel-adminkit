@extends('layouts.adminkit.master')
                ...
                <div class="col-md-4 col-xl-3">
                    <div class="card mb-3">
                        ...
                        <div class="card-body text-center">
                            <img src="/adminkit/img/avatars/user.png" alt="Christina Mason"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body h-100">
                            ...
                            <div class="d-flex align-items-start">
                                <img src="/adminkit/img/avatars/user.png" width="36" height="36"
...
@section('myjs')
    <script>
        let menuSidebar = document.querySelector("#menu-profile");
